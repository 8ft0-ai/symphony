defmodule SymphonyElixir.TestSupport do
  ...
  defp workflow_content(overrides) do
    config =
      Keyword.merge(
        [
          ...
          observability_transcripts_enabled: true,
          observability_transcripts_root: nil,
          observability_transcript_recent_events_limit: 50,
    ...
    observability_transcripts_enabled = Keyword.get(config, :observability_transcripts_enabled)
    observability_transcripts_root = Keyword.get(config, :observability_transcripts_root)
    observability_transcript_recent_events_limit = Keyword.get(config, :observability_transcript_recent_events_limit)
    ...
    sections =
      [
        ...
        observability_yaml(
          ...
          observability_transcripts_enabled,
          observability_transcripts_root,
          observability_transcript_recent_events_limit,
  ...
  defp observability_yaml(
         ...
         transcripts_enabled,
         transcripts_root,
         transcript_recent_events_limit,
         refresh_ms,
         render_interval_ms
       ) do
    [
      ...
      "  transcripts_enabled: #{yaml_value(transcripts_enabled)}",
      "  transcripts_root: #{yaml_value(transcripts_root)}",
      "  transcript_recent_events_limit: #{yaml_value(transcript_recent_events_limit)}",
